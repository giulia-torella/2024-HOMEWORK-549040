...
public class StanzaTest {
    ...
    public void testRemoveAttrezzoOsso() {
    	assertNotNull(stanza("Atrio", new Attrezzo("osso", 0)).removeAttrezzo(new Attrezzo("osso", 1)));
    }
    
    @Test
    public void testNotRemoveAttrezzoOsso() {
    	assertNull(stanza("Atrio", new Attrezzo("osso", 0)).removeAttrezzo(new Attrezzo("martello", 1)));
    }
