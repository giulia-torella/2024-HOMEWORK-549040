...
public class Stanza {
	...
	/* IMPLEMENTATO IO */
	public Attrezzo removeAttrezzo(String attrezzo) { // estrae attrezzo dalla stanza
		Attrezzo a = null;
		for(int i=0; i<numeroAttrezzi; i++) {
			if(attrezzo != null)
			    if(this.attrezzi[i].getNome().equals(attrezzo)) {
				    ...
				    numeroAttrezzi--;
				    console.mostraMessaggio("Ho rimosso " + attrezzo + " dalla stanza.");
			    }
			else 
				console.mostraMessaggio("Non esiste un attrezzo di nome " + attrezzo + " nella stanza.");
		}
		return a;
	}
